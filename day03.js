...
const avengers = ['美国队长','钢铁侠','雷神','黑寡妇'];
...
console.log('a=${a}, b=${b}, c=${c}');
//解构
const [a,b] = ['Tianguiping',true,1,2,2,1];
console.log('a=${a}, b=${b}');
...
const avengers = ['美国队长','钢铁侠','雷神','绿巨人'];
avengers.pop();//pop删掉数组中最后一个元素
console.log(avengers);
avengers.push('Tianguiping');//push将新值添加到数组的末尾
console.log(avengers);
...
const avengers = ['美国队长','钢铁侠','雷神','绿巨人'];
const av4 = avengers.splice(1,2,'Tian','chi','adsfa');
console.log(av4);
console.log(avengers)
